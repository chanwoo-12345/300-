...
const quizzes = [
  ...
  { question: "25년 7월 22일 해방촌에서 방문했던 편지 적는 카페 이름은?", options: ["해방 공원", "팬스 댄스", "널 담은 공간", "KKI"], answer: 2, memory: "이태원 처음 가보는 곳이었는데 여진이와 함께라서 너무 기뻤어." },
  { question: "25년 7월 28일 수원역에서 내가 뽑아준 인형의 이름은?", options: ["투슬리스", "패트와 매트", "메타몽", "맥그로우"], answer: 0, memory: "투슬리스가 셋!! 푸힣 >< 이 날 스톤 카페도 너무 좋았어." },
  { question: "25년 8월 5일 성수동에서 먹은 음식이 아닌 것은?", options: ["규카츠", "양꼬치", "오미자 크러쉬", "리소토"], answer: 3, memory: "날씨가 더운 것 빼고는 모든 게 완벽했던 하루." },
  { question: "25년 8월 11일 서울숲에서 하지 않은 것은?", options: ["스시 먹기", "라멘 먹기", "신문지 사진 찍기", "라프레플루트 방문"], answer: 1, memory: "라프레플루트 가고 싶어서 서울숲 데이트!! 도토리 캐리커쳐도 다녀왔지. 스시집이랑 라프레플루트 재방문하고 싶어 ㅠㅠ." },
  ...
  { question: "앞으로도 예쁜 ___ 하자.", options: ["공부", "운동", "사랑", "게임"], answer: 2, memory: "예쁜 사랑 계속하자 💗" },
